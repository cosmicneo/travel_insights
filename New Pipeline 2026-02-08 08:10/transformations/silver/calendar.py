...
start_date = "2025-01-01"#spark.conf.get("start_date")
end_date = "2025-12-31"#spark.conf.get("end_date")


@dlt.table(
    name="travel_insights.silver.calendar",
    comment="Calendar dimension with comprehensive date attributes and Indian holidays (2025)",
    table_properties={
        "quality": "travel_insights.silver.calendar",
        "layer": "silver",
